...
pokemonFromName = (name, msg) ->
  pokemonId = (id for id, pokemonName of pokemonNames when pokemonName.toLowerCase() == name.toLowerCase())[0]
  
  unless pokemonId?
    suggestions = (pokemonName for id, pokemonName of pokemonNames when (levenstein pokemonName, name) < 3).join(', ')
